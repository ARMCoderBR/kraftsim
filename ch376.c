...
const unsigned char disk_mbr[] = {
  ...
  0x06,                     // Partition type = FAT16B
  //0x0c,                     // Partition type = FAT32

  0xfe, 0xff, 0xff,
  0x20, 0x00, 0x00, 0x00,   // Start sector = 32

  0x00, 0x00, 0x08, 0x00,   // # sectors = 1024*1024*100 / 512 (256M)
  //0x00, 0x20, 0x03, 0x00,   // # sectors = 1024*1024*100 / 512 (100M)
